...
/*   Updated: 2020/03/12 17:21:51 by mdavid           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
** Others functions
*/
void	ft_stck_splt2b(t_pp *d_a, t_pp *d_b, t_info *info_a, t_info *info_b, int (*ft_order)(int*, int**, size_t));
void	ft_stck_splt2a(t_pp *d_a, t_pp *d_b, t_info *info_a, t_info *info_b, int (*ft_order)(int*, int**, size_t));
